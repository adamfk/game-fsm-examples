...
// check url parameter for enemy type
const enemyId = parseInt(new URLSearchParams(document.location.search).get('enemyId') || "0");
const enemyCtorName = 'Enemy' + enemyId;

console.log('enemyType:', enemyCtorName);
/** @type {function(new:Enemy, Vector2)} */
const enemyCtor = window[enemyCtorName];
...
/** @type {Player} */
let player;
let playerStartPos, tileData, tileLayers, foregroundLayerIndex, sky;
